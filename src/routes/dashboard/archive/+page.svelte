...
<div>
    ...
    >
        ...
        <button
            onclick={exportAsCSV}
            class="flex items-center gap-2 px-4 py-2.5 text-sm font-bold rounded-xl bg-gov-green/10 text-gov-green hover:bg-gov-green/20 transition-colors flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
