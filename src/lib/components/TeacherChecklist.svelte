<script lang="ts">
    ...
    // Calculate expectations based on weeks × teaching loads
...
<div class="gov-card-static overflow-hidden">
    <!-- Header -->
    <div class="px-6 py-5 border-b border-border-subtle bg-white flex items-center justify-between flex-wrap gap-4">
    ...
    {#if statistics.total > 0}
        <div class="px-6 py-5 bg-surface-muted/30 border-b border-border-subtle">
    ...
    <div class="overflow-x-auto custom-scrollbar">
        ...
        {:else}
            <table class="w-full text-left border-collapse text-sm">
                <thead>
                    <tr class="bg-surface-muted/50 border-b border-border-subtle">
                ...
                <tbody class="divide-y divide-border-subtle">
                    {#each calendarWeeks as week}
                        <tr class="hover:bg-gov-blue/5 transition-colors group">
                            <td class="py-2 px-3 sticky left-0 bg-white border-r border-border-subtle z-10 group-hover:bg-gov-blue/5 transition-colors">
    ...
    <!-- Legend & Notes -->
    <div class="px-6 py-4 bg-surface-muted/30 border-t border-border-subtle text-[10px] text-text-muted space-y-2">
